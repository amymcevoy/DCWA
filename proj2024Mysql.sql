...
M.cfg = {"wwwroot":"https:\/\/vlegalwaymayo.atu.ie","homeurl":{},"sesskey":"5BLDG22fOK","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1734682809","slasharguments":1,"theme":"lambda2","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1734682809","admin":"admin","svgicons":true,"usertimezone":"Europe\/Dublin","language":"en","courseId":10371,"courseContextId":1266859,"contextid":1329072,"contextInstanceId":998986,"langrev":1734682809,"templaterev":"1734682809"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<div class="wrapper-lambda">
    ...
    id="nav-notification-popover-container" data-userid="50520"
    data-region="popover-region">
    <div class="popover-region-toggle nav-link icon-no-margin"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-677993c5253fa677993c51ef2d5"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-677993c5253fa677993c51ef2d5"
    ...
    <a id="message-drawer-toggle-677993c525cdf677993c51ef2d6" class="nav-link popover-region-toggle position-relative icon-no-margin" href="#"
            role="button">
    ...
    <span class="sr-only sr-only-focusable" data-region="jumpto" tabindex="-1"></span></div>
	                    				...
	                    				<div class="usermenu">
	                    				        <div class="dropdown show">
	                    				            <a href="#" id="user-menu-toggle" data-toggle="dropdown" aria-label="User menu"
	                    				               aria-haspopup="true" aria-controls="user-action-menu" class="dropdown-toggle">AMY MC EVOY
	                    				                <span class="userbutton">
	                    				                    <span class="avatars">
	                    				                            <span class="avatar current">
	                    				                                <span class="userinitials size-35">AM</span>
	                    				                            </span>
	                    				                    </span>
	                    				                </span>
	                    				            </a>
	                    				                ...
	                    				                <div id="usermenu-carousel" class="carousel slide" data-touch="false" data-interval="false" data-keyboard="false">
	                    				                    <div class="carousel-inner">
	                    				                        <div id="carousel-item-main" class="carousel-item active" role="menu" tabindex="-1" aria-label="User">
	                    				                                ...
	                    				                                <div class="dropdown-divider"></div>
	                    				                                    <a href="https://vlegalwaymayo.atu.ie/login/logout.php?sesskey=5BLDG22fOK" class="dropdown-item" role="menuitem" tabindex="-1">
	    						...
	    						<a href="https://vlegalwaymayo.atu.ie/user/view.php?id=50520&amp;course=10371" class="d-inline-block aabtn"><span class="userinitials size-75">AM</span></a>
	    				</div>
	    			</div>
	    		</div>
	    	</div>
	            ...
	            <nav class="navbar navbar-expand">
	    			<div class="menu">
	            		<nav class="moremenu navigation">
	            		    <ul id="moremenu-677993c523484-navbar-nav" role="menubar" class="nav more-nav navbar-nav">
	            		        ...
	            		        <li role="none" class="nav-item dropdown dropdownmoremenu d-none" data-region="morebutton">
	            		            <a class="dropdown-toggle nav-link " href="#" id="moremenu-dropdown-677993c523484" role="menuitem" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" tabindex="-1">
	            		                More
	            		            </a>
	            		            <ul class="dropdown-menu dropdown-menu-left" data-region="moredropdown" aria-labelledby="moremenu-dropdown-677993c523484" role="menu">
	            		            </ul>
	            		        </li>
	            		    </ul>
	            		</nav>
...
<p></p>
                    ...
                    <div class="logininfo">You are logged in as <a href="https://vlegalwaymayo.atu.ie/user/profile.php?id=50520" title="View profile">AMY MC EVOY</a> (<a href="https://vlegalwaymayo.atu.ie/login/logout.php?sesskey=5BLDG22fOK">Log out</a>)</div>
...
M.util.js_pending('filter_ally/main'); require(['filter_ally/main'], function(amd) {amd.init("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MzYwMjA5MzMsImNvdXJzZV9pZCI6MTAzNzEsInJvbGVzIjoidXJuOmx0aTpyb2xlOmltcy9saXMvTGVhcm5lciIsInVzZXJfaWQiOjUwNTIwLCJsb2NhbGUiOiJlbiIsInJldHVybl91cmwiOiJodHRwczovL3ZsZWdhbHdheW1heW8uYXR1LmllIn0.U-W_nk4oq_7VSo76l4_iTW16SSr1k-uiXRdYqedGPQ4", {"adminurl":"https:\/\/prod-eu-central-1.ally.ac\/api\/v1\/718\/lti\/institution","pushurl":"https:\/\/prod-eu-central-1.ally.ac\/api\/v1\/events","clientid":"718"}, false, true, "10371", {}); M.util.js_complete('filter_ally/main');});;
M.util.js_pending('core_courseformat/courseeditor'); require(['core_courseformat/courseeditor'], function(amd) {amd.setViewFormat("10371", {"editing":false,"supportscomponents":true,"statekey":"1734682809_1736020933"}); M.util.js_complete('core_courseformat/courseeditor');});;
...
function(
    ...
    var toggle = $('#message-drawer-toggle-677993c525cdf677993c51ef2d6');
    Popover.init(toggle);
});
;
...
;
    ...
    require(['core/moremenu'], function(moremenu) {
        moremenu(document.querySelector('#moremenu-677993c523484-navbar-nav'));
    });
;

require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-677993c527fb6677993c51ef2d7');
    MessageDrawer.init(root, '677993c527fb6677993c51ef2d7', false);
});
;
...
M.util.js_pending('core/storage_validation'); require(['core/storage_validation'], function(amd) {amd.init(1736020690); M.util.js_complete('core/storage_validation');});
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random677993c51ef2d8'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random677993c51ef2d8'); });
})();
//]]>
</script>
...
<div
    id="drawer-677993c527fb6677993c51ef2d7"
    ...
    tabindex="0"
>
            <div id="message-drawer-677993c527fb6677993c51ef2d7" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                ...
                </div>                <div class="hidden h-100" data-region="view-contacts" aria-hidden="true" data-user-id="50520">
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-677993c527fb6677993c51ef2d7"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-677993c527fb6677993c51ef2d7"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-677993c527fb6677993c51ef2d7"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-677993c527fb6677993c51ef2d7"
                                        class="nav-link"
                                        href="#requests-tab-panel-677993c527fb6677993c51ef2d7"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-677993c527fb6677993c51ef2d7"
                                        aria-selected="false"
                                    >
                                        Requests
                    ...
                    data-user-id="50520"
                                        id="contacts-tab-panel-677993c527fb6677993c51ef2d7"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-677993c527fb6677993c51ef2d7"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="50520"
                                        id="requests-tab-panel-677993c527fb6677993c51ef2d7"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-677993c527fb6677993c51ef2d7"
                ...
                >
                    <div
                        ...
                        style="overflow-y: auto"
                    ></div>
                </div>                <div class="h-100 view-overview-body" aria-hidden="false" data-region="view-overview"  data-user-id="50520">
                    <div id="message-drawer-view-overview-container-677993c527fb6677993c51ef2d7" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-677993c527fb6677993c51ef2d7"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-677993c527fb6677993c51ef2d7"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="50520"
                                            id="view-overview-favourites-target-677993c527fb6677993c51ef2d7"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-677993c527fb6677993c51ef2d7"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex rounded-0 align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-677993c527fb6677993c51ef2d7"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-677993c527fb6677993c51ef2d7"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="50520"
                                            id="view-overview-group-messages-target-677993c527fb6677993c51ef2d7"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex rounded-0 align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-677993c527fb6677993c51ef2d7"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-677993c527fb6677993c51ef2d7"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="50520"
                                            id="view-overview-messages-target-677993c527fb6677993c51ef2d7"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-677993c527fb6677993c51ef2d7-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-677993c527fb6677993c51ef2d7-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-677993c527fb6677993c51ef2d7-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-677993c527fb6677993c51ef2d7-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-677993c527fb6677993c51ef2d7" checked>
                                    <label class="custom-control-label" for="enter-to-send-677993c527fb6677993c51ef2d7">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
